  ...
  api.registerCommand({
    ...
    fn: function () {
      var _fn = _asyncToGenerator(function* () {
        ...
        const _ref = yield (0, _buildDevUtils.getBundleAndConfigs)({
          api
        }),
              bundler = _ref.bundler,
              bundleConfigs = _ref.bundleConfigs,
              bundleImplementor = _ref.bundleImplementor;
        ...
        try {
          ...
          const _ref2 = yield bundler.build({
            bundleConfigs,
            bundleImplementor
          }),
                stats = _ref2.stats;
