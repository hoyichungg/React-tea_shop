...
function Switch(props) {
  return React__default.createElement(runtime.__RouterContext.Consumer, null, function (context) {
...
function Route(props) {
  return React__default.createElement(runtime.__RouterContext.Consumer, null, function (context) {
    ...
    return React__default.createElement(runtime.__RouterContext.Provider, {
      value: newProps
...
function getRouteElement(_ref3) {
  ...
  if (route.redirect) {
    return React__default.createElement(runtime.Redirect, _extends({}, routeProps, {
      from: route.path,
      to: route.redirect
    }));
  } else {
    return React__default.createElement(Route, _extends({}, routeProps, {
...
function renderRoutes(opts) {
  return opts.routes ? React__default.createElement(Switch, null, opts.routes.map(function (route, index) {
...
function RouterComponent(props) {
  ...
  return React__default.createElement(runtime.Router, {
    history: history
