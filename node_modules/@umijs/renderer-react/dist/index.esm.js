...
function Route(props) {
  return React.createElement(__RouterContext.Consumer, null, function (context) {
    ...
    return React.createElement(__RouterContext.Provider, {
      value: newProps
...
function getRouteElement(_ref3) {
  ...
  if (route.redirect) {
    return React.createElement(Redirect, _extends({}, routeProps, {
      from: route.path,
      to: route.redirect
    }));
  } else {
...
function renderRoutes(opts) {
  return opts.routes ? React.createElement(Switch, null, opts.routes.map(function (route, index) {
