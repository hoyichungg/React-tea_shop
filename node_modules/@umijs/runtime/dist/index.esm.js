      ...
      if (memberKeys.length) {
        hooks = hooks.map(function (hook) {
          try {
            ...
            try {
              for (var _iterator = memberKeys[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
  ...
  var loadableOptions = {
    loading: function loading(_ref) {
      ...
      if (process.env.NODE_ENV === 'development') {
        ...
        if (error) {
          return createElement("p", null, error.message, createElement("br", null), error.stack);
        }
      }
